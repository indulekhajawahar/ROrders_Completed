...
import com.example.rorders.kitchen.adapter.KitchenOrdersTableAdapter
...
class KitchenOrdersActivity : AppCompatActivity() {
    ...
    private fun orderdetail(){
        ...
        firebaseDatabase.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val menuAdapter= KitchenOrdersTableAdapter(nContext,tableList)
