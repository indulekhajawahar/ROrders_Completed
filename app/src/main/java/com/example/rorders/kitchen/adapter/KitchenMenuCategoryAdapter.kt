...
class KitchenMenuCategoryAdapter (
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        var adapter= KitchenMenuItemsAdapter(mContext,categoryArrayList[position].detailList,
